...
export default class Parser {
	...
	private parse_stmt(): Stmt {
		...
		switch (this.at().type) {
			...
			case TokenType.pspsps:
				return this.parse_pspsps_declaration();
			default:
				return this.parse_expr();
		}
	}

	parse_pspsps_declaration(): Stmt {
		this.eat(); // eat pspsps keyword
		const name = this.expect(
			TokenType.Identifier,
			"Expected function name following pspsps keyword"
		).value;
